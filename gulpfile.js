...
function fontsStyle(params) {
  let file_content = fs.readFileSync(source_folder + "/scss/components/_fonts.scss");
  if (file_content == "") {
    fs.writeFile(source_folder + "/scss/components/_fonts.scss", "", cb);
      ...
      if (items) {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          if (c_fontname != fontname) {
            fs.appendFile(
              source_folder + "/scss/components/_fonts.scss",
              '@include font("' +
              fontname +
              '", "' +
              fontname +
